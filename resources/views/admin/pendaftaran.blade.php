...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="pendaftaran" class="w3-bar-item w3-button w3-padding w3-orange"><i class="fa fa-plus-square fa-fw"></i>  Pendaftaran Misa</a>
...
<header class="w3-container" style="padding-top:22px">
    ...
    <div>
        ...
        <td><a href="/deletejadwal/{{$jadwalmisa->id}}" class="btn btn-primary w3-orangemary w3-orange">Delete</a></td>
        @endforeach
        </tr>
        </div>
        </table>
